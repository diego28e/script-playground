...
import { BookOpen, Code2, CheckCircle2, Languages } from "lucide-react";
        ...
        <div className="flex h-[calc(100vh-4rem)] flex-col">
            ...
            <div className="flex border-b bg-zinc-50 dark:bg-zinc-900 md:hidden">
                <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium transition-colors ${mobileView === 'description'
                ...
                <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium transition-colors ${mobileView === 'code'
                        ? 'border-b-2 border-zinc-900 text-zinc-900 dark:border-zinc-50 dark:text-zinc-50'
                        : 'text-zinc-500 hover:text-zinc-700 dark:text-zinc-400 dark:hover:text-zinc-300'
                        }`}
                >
            ...
            <div className="flex-1 overflow-hidden md:hidden">
                {mobileView === 'description' ? (
                    <div className="h-full overflow-y-auto bg-white p-4 dark:bg-zinc-950" style={{ WebkitOverflowScrolling: 'touch' }}>
